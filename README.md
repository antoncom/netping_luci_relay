...
1. ~Добавить подтверждение на удаление (модальное окно "Удалить реле?")~ (![скриншот](https://github.com/antoncom/netping_luci_relay/blob/main/screenshot/2020-10-26-122338_1920x1080_scrot.png))
